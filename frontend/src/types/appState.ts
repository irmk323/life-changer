...
export interface Task {id:string;title:string;category:string;status:TaskStatus;attempts:{id:string;date:string;duration:number;result:LearningResult;notes:string}[];notes?:string;source?:'BUILT_IN'|'CUSTOM';[key:string]:unknown}
