...
export const sampleData = (): AppState => {
  ...
  return {
    ...
    systemDesignTasks: designTitles.map((title, i) => ({ id: `design-${i + 1}`, title, category: "System design", statement: `Design a scalable ${title}.`, functional: "", nonFunctional: "", capacity: "", api: "", dataModel: "", highLevel: "", scaling: "", consistency: "", reliability: "", observability: "", security: "", tradeoffs: "", bottlenecks: "", notes: "", status: i === 0 ? "LEARNING" : "NOT_STARTED", attempts: [] })),
  };
};
